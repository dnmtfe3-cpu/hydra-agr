  ...
  return (
    <main className={`auth-shell auth-shell-motion ${mode === "signup" ? "auth-shell-signup" : ""} ${loginStep === "staff" ? "auth-shell-staff" : ""}`}>
      ...
      <section className={`auth-card ${mode === "signup" ? "auth-card-wide" : ""}`}>
        ...
        <div className="auth-web-brand" aria-label="Hydra Agro"><HydraMark className="auth-web-brand-mark" /><span className="auth-web-brand-name"><strong>HYDRA</strong><b>AGRO</b></span></div>
